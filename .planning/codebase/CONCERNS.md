...
### [HIGH] **[FIXED]** Duplicated `parse_link_payload` and API retry logic across two validation scripts
...
### [HIGH] **[FIXED]** Both validation scripts fetch 5 identical KEGG API endpoints independently — 10 total live API calls per pipeline run
